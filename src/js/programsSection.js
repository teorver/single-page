document.addEventListener("DOMContentLoaded", () => {
    ...
    const programDescriptions = {
        ...
        "program-item-3": "<p>Это программа физического, эмоционального, духовного и социального восстановления (Rehab (англ.) – реабилитация, восстановление).</p>" +
            "<p>Зависимость/созависимость – это болезнь, которую там и тогда Вы себе не выбирали.<br> Здесь и сейчас выбор за Вами.</p>" +
            "<p>Трезвость нужна, чтобы чувствовать радость, счастье и свободу в своей жизни.</p>" +
            "<p>Свобода для меня – это быть живой, чувствовать дыхание ветра и ароматный шелест листьев под ногами, слышать, как мурлыкает кот и расплываться в улыбке, видя дорогих мне людей, зная при этом, что видят и слышат меня без пелены со/зависимости, которая когда-то крала все это у меня…</p>" +
            ...
            "- На выходе Ваша физическая сила, выносливость и активность вырастут</p>" +
            "<p><strong>В работе использованы:</strong><br>" +
            ...
            "Стабилизационный комплекс день-ночь</p>" +
            "<p><strong>Формат онлайн работы:</strong><br>" +
            ...
            "*Длительность консультации 50 минут.</p>",
    };
